...
case "$choice" in
  ...
  find .github/ -type f -name "*.md" -print0 | xargs -0 sed -i "s/Josee9988/${NEW_USERNAME}/g"
  find .github/ -type f -name "*.md" -print0 | xargs -0 sed -i "s/jgracia9988@gmail.com/${NEW_EMAIL}/g"
  ;;
  n|N ) exit 0;;
  * ) echo "Invalid option";;
esac
